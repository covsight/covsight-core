...
class TestApiScopeHierarchy:
    ...
    def test_create_design_unit(self, backend):
        ...
        du = db.createScope(
            ...
            FlagsT.SCOPE_UNDER_DU | FlagsT.INST_ONCE | FlagsT.ENABLED_STMT
        )
        ...
        inst = db.createInstance("du_inst", None, 1, SourceT.VLOG, ScopeTypeT.INSTANCE, du, FlagsT.INST_ONCE)
    ...
    def test_create_instance_with_du_reference(self, backend):
        ...
        inst = db.createInstance(
            ...
            1, SourceT.VLOG, ScopeTypeT.INSTANCE, du, FlagsT.INST_ONCE
        )
    ...
    def test_nested_hierarchy(self, backend):
        ...
        top_inst = db.createInstance(
            "top",
            None, 1, SourceT.VLOG, ScopeTypeT.INSTANCE, du, FlagsT.INST_ONCE
        )
        ...
        child_inst = top_inst.createInstance(
            "child",
            None, 1, SourceT.VLOG, ScopeTypeT.INSTANCE, child_du, FlagsT.INST_ONCE
        )
    ...
    def test_scope_weights(self, backend):
        ...
        inst1 = db.createInstance("inst1", None, 1, SourceT.VLOG, ScopeTypeT.INSTANCE, du, FlagsT.INST_ONCE)
        inst2 = db.createInstance("inst2", None, 10, SourceT.VLOG, ScopeTypeT.INSTANCE, du, FlagsT.INST_ONCE)
        inst3 = db.createInstance("inst3", None, 100, SourceT.VLOG, ScopeTypeT.INSTANCE, du, FlagsT.INST_ONCE)
