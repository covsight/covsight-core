...
from covsight.core.ncdb.constants import MEMBER_FSM
from covsight.core.ncdb.fsm import FsmReader, FsmWriter
...
def test_fsm_merged_cdb_states_transitions_intact():
    ...
    import shutil
    from covsight.core.api.sqlite.sqlite_ucis import SqliteUCIS
    ...
    with tempfile.TemporaryDirectory() as d:
        ...
        from covsight.core.api.sqlite.sqlite_ucis import SqliteUCIS as _SU
