...
class TestApiCodeCoverage:
    ...
    def test_statement_coverage(self, backend):
        ...
        testnode = db.createHistoryNode(None, "test", "test", HistoryNodeKind.TEST)
        testnode.setTestData(TestData(teststatus=TestStatusT.OK,
        ...
        du = db.createScope("work.module1", SourceInfo(file_h, 1, 0),
                           1, SourceT.VLOG, ScopeTypeT.DU_MODULE,
                           FlagsT.SCOPE_UNDER_DU | FlagsT.INST_ONCE)
        
        inst = db.createInstance("i_module1", None, 1, SourceT.VLOG,
    ...
    def test_condition_coverage(self, backend):
        ...
        inst.createNextCover("#cond#1#30#1#", CoverData(CoverTypeT.CONDBIN, 4), SourceInfo(file_h, 30, 0))  # TT
        inst.createNextCover("#cond#1#30#2#", CoverData(CoverTypeT.CONDBIN, 2), SourceInfo(file_h, 30, 0))  # TF
        inst.createNextCover("#cond#1#30#3#", CoverData(CoverTypeT.CONDBIN, 3), SourceInfo(file_h, 30, 0))  # FT
        inst.createNextCover("#cond#1#30#4#", CoverData(CoverTypeT.CONDBIN, 1), SourceInfo(file_h, 30, 0))  # FF
    ...
    def test_expression_coverage(self, backend):
        ...
        # Expression: (a + b) > c
        inst.createNextCover("#expr#1#40#1#", CoverData(CoverTypeT.EXPRBIN, 8), SourceInfo(file_h, 40, 0))  # True
        inst.createNextCover("#expr#1#40#2#", CoverData(CoverTypeT.EXPRBIN, 2), SourceInfo(file_h, 40, 0))  # False
    ...
    def test_block_coverage(self, backend):
        ...
        # Basic blocks
        inst.createNextCover("#block#1#50#1#", CoverData(CoverTypeT.BLOCKBIN, 10), SourceInfo(file_h, 50, 0))
        inst.createNextCover("#block#1#55#1#", CoverData(CoverTypeT.BLOCKBIN, 10), SourceInfo(file_h, 55, 0))
        inst.createNextCover("#block#1#60#1#", CoverData(CoverTypeT.BLOCKBIN, 0), SourceInfo(file_h, 60, 0))
    ...
    def test_multiple_code_coverage_types(self, backend):
        ...
        inst.createNextCover("#stmt#1#10#1#", CoverData(CoverTypeT.STMTBIN, 5), SourceInfo(file_h, 10, 0))
        inst.createNextCover("#branch#1#20#1#", CoverData(CoverTypeT.BRANCHBIN, 3), SourceInfo(file_h, 20, 0))
        inst.createNextCover("#cond#1#30#1#", CoverData(CoverTypeT.CONDBIN, 2), SourceInfo(file_h, 30, 0))
        inst.createNextCover("#expr#1#40#1#", CoverData(CoverTypeT.EXPRBIN, 7), SourceInfo(file_h, 40, 0))
        inst.createNextCover("#block#1#50#1#", CoverData(CoverTypeT.BLOCKBIN, 4), SourceInfo(file_h, 50, 0))
