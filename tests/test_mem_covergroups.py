...
class TestApiCovergroups:
    ...
    def test_covergroup_options(self, backend):
        ...
        cg = inst.createCovergroup("cg_opts", SourceInfo(file_h, 5, 0), 1, SourceT.VLOG)
    ...
    def test_covergroup_weight(self, backend):
        ...
        cg1 = inst.createCovergroup("cg_w1", SourceInfo(file_h, 5, 0), 1, SourceT.VLOG)
        cg2 = inst.createCovergroup("cg_w10", SourceInfo(file_h, 6, 0), 10, SourceT.VLOG)
        cg3 = inst.createCovergroup("cg_w100", SourceInfo(file_h, 7, 0), 100, SourceT.VLOG)
    ...
    def test_multiple_covergroups(self, backend):
        ...
        for i in range(5):
            cg_name = f"cg_{i}"
            cg = inst.createCovergroup(cg_name, SourceInfo(file_h, 10+i, 0), 1, SourceT.VLOG)
    ...
    def test_covergroup_goal(self, backend):
        ...
        cg = inst.createCovergroup("cg_goal", SourceInfo(file_h, 5, 0), 1, SourceT.VLOG)
        cg.setGoal(90)
