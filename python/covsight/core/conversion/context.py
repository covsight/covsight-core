...
from covsight.core.conversion.error import ConversionError
from covsight.core.conversion.listener import ConversionListener
...
class ConversionContext:
    ...
    Args:
        ...
        listener: Progress listener to drive.  Defaults to a no-op
            :class:`~covsight.core.conversion.listener.ConversionListener`.
