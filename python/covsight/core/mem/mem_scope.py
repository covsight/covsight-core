...
from covsight.core.mem.mem_obj import MemObj
from covsight.core.mem.mem_scope_iterator import MemScopeIterator
from covsight.core.api import Scope
...
from covsight.core.mem.mem_cover_index_iterator import MemCoverIndexIterator
...
class MemScope(MemObj,Scope):
    ...
    def createToggle(self,
        ...
        from covsight.core.mem.mem_toggle_scope import MemToggleScope
